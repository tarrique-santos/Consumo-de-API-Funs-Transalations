...
let url = "https://api.funtranslations.com/translate/enderman.json"
...
async function traducao() {
  ...
  const result = await fetch(`https://api.funtranslations.com/translate/enderman.json?text=${txt_entrada.value}`)
